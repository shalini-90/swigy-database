...
def get_restaurant_data(restaurant):
    ...
    try:
        ...
        for menu in menu_list:
            ...
            val = [(str(restaurant))]
            query = f"INSERT INTO restaurant_table(restaurant_name,descriptions_li ,dish_li , price_li) VALUES ('{res_name}', '{desc}', '{dish_name}', {price});"
            print('\n\n\n\t\tQUERY:\n', f'\t{query}\n\n') 
            
            print(mycursor.rowcount, "record inserted.")
        get_csv(descriptions_li, dish_li, price_li,restaurant_name) 
    except:
        pass

def get_csv(descriptions_li, dish_li, price_li,restaurant_name):
    zoo ={ 
    "RE_NAME":restaurant_name,
    ...
    try:
        ...
        mycursor.executemany(sql, restore) 
    except: 
        pass
    mydb.commit()
